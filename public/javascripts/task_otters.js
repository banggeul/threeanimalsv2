...
import store from '/utils/storage_otters.js'
import {instructions} from '/instructions/task_otter/instructions.js'
...
sequenceSets = sequenceSetRandom;
...
let instTexts = [];
let nextBtns = [];
const pathToSlides = "/instructions/task_otter/";
...
let demoMsgs = {
  ...
  "Do you see where Sasha is standing?",
...
sprite_c.src = "media_assets/otter/card_anim/fish_yes.png";

let sprite_d = new Image();
sprite_d.onload = initDirt;
sprite_d.src = "media_assets/otter/card_anim/fish_no.png";
